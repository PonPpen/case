...
(function(a){
    a.fn.slideshow_buttontitle=function(p){
        ...
        var o=p&&p.window_padding?p.window_padding:"2";
		...
		var q=p&&p.title_width?p.title_width:"400";
        var u=p&&p.title_text_color?p.title_text_color:"red";
		var u=p&&p.title_text_size?p.title_text_size:"12";
        var v=p&&p.title_background?p.title_background:"";
        var w=p&&p.button_color?p.button_color:"blue";
        var x=p&&p.button_current_color?p.button_current_color:"white";
        var y=p&&p.button_size?p.button_size:"6";
        o += "px";
        q += "px";
        r += "px";
        s += "px";
        ...
        function play(){
            ...
            B.find(".slideshow_simple1_nav").children("li").css("background",w);
            B.find(".slideshow_simple1_nav").children("li").eq(A).css("background",x);
