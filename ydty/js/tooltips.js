...
function show_err_msg(msg){
	 ...
	 var errhtml='<div style="padding:8px 0px;border:1px solid #3d8ad1;width:100%;margin:0 auto;background-color:#fff;color:#3d8ad1;border:3px #3d8ad1 solid;text-align:center;font-size:16px;font-family:微软雅黑;"><img style="margin-right:10px;" src="img/error.png">';
	 var errhtmlfoot='</div>';	 
...
function show_msg(msg,url){	
	 ...
	 clearTimeout(msgdsq);
	 $('body').append('<div class="sub_err" style="position:absolute;top:60px;left:0;width:500px;z-index:999999;"></div>');
	 var htmltop='<div style="padding:8px 0px;border:1px solid #090;width:100%;margin:0 auto;background-color:#FFF2F8;color:#3d8ad1;border:3px #3d8ad1 solid;;text-align:center;font-size:16px;"><img style="margin-right:10px;" src="img/success.png">';
	 var htmlfoot='</div>';
	 $('.msg_bg').height($(document).height());
	 var left=($(document).width()-500)/2;
	 $('.sub_err').css({'left':left+'px'});
